...
public class PacienteMenu extends JFrame {
    ...
    public PacienteMenu(PacienteDTO pacienteDTO) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAgendarCita.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Opción: Agendar Cita");
            }
        });
        ...
        btnVerCitas.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Opción: Ver Citas Próximas");
            }
        });
        ...
        btnVerHistorial.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Opción: Ver Historial");
            }
        });
        ...
        btnEditarPerfil.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Opción: Editar Perfil");
            }
        });
    ...
    private void initializeComponents(PacienteDTO pacienteDTO) {
       ...
       // lblBienvenido.setText("¡Bienvenido de vuelta, " + pacienteDTO.getNombre() + "!");
      //  lblNombreCompleto.setText(pacienteDTO.getNombre() + " " + pacienteDTO.getApellidoP() + " " + pacienteDTO.getApellidoM());
    }
}
